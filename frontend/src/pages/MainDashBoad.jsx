...
const MainDashBoad = () => {
    ...
    const StatCard = ({ title, value, subtitle, icon, color = 'blue', trend, path }) => {
        const colorConfig = {
        ...
        return (
            <div onClick={() => Navigate(path)} className="bg-white cursor-pointer rounded-2xl shadow-lg border border-slate-200 p-6 backdrop-blur-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
            ...
            <div className="">
                ...
                {/* Dashboard Content */}
                <main className="p-4 sm:p-3 md:p-4 lg:p-6 ">
                    {/* Stats Overview */}
                        ...
                        <div className="xl:col-span-2 space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {[
                                        { label: 'Add Project', icon: <HiOutlineOfficeBuilding />, color: 'blue' },
                                        ...
                                        <button
                                            ...
                                            className="flex flex-col items-center p-4 bg-slate-50 rounded-2xl border border-slate-200 hover:border-blue-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
                                        >
                                            <div className={`w-12 h-12 bg-${action.color}-500 rounded-2xl flex items-center justify-center text-white mb-3 group-hover:scale-110 transition-transform`}>
                                                {action.icon}
                                            </div>
                                    ...
                                    {[
                                        ...
                                        <div key={index} className="flex items-center justify-between p-3 rounded-2xl border border-slate-200 hover:border-amber-300 transition-colors">
                                            ...
                                            <div className="text-right">
                                                <span className={`px-2 py-1 rounded-full text-xs font-semibold ${deadline.priority === 'high' ? 'bg-red-100 text-red-700' :
